...
<head>
    ...
    <title>ONU mujeres - Resumen</title>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Formularios completados (7 días)</div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Progreso en desempeño</h6>
                            </div>
                            <div class="card-body">
                                <div class="mb-1 small">
                                    Última semana: <strong>${avanceResultados.totalesGenerales[0]}</strong> formularios
                                </div>
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-success" role="progressbar"
                                         style="width: ${avanceResultados.totalesGenerales[0]}px;
                                         aria-valuenow="${avanceResultados.totalesGenerales[0]}" aria-valuemin="0" aria-valuemax="/* Define un máximo lógico */">
                                        ${avanceResultados.totalesGenerales[0]}
                                    </div>
                                </div>

                                <div class="mb-1 small">
                                    Último mes: <strong>${avanceResultados.totalesGenerales[1]}</strong> formularios
                                </div>
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-info" role="progressbar"
                                         style="width: ${avanceResultados.totalesGenerales[1]}px;
                                         aria-valuenow="${avanceResultados.totalesGenerales[1]}" aria-valuemin="0" aria-valuemax="/* Define un máximo lógico */">
                                        ${avanceResultados.totalesGenerales[1]}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <c:forEach items="${listaFormularios}" var="formulario" varStatus="loop">
                                    <div class="mb-1 small">
                                            ${formulario.key}: <strong>${formulario.value}</strong> completados
                                    </div>
                                    <div class="progress mb-4">
                                        <div class="progress-bar
                        ${loop.index % 5 == 0 ? 'bg-info' :
                          loop.index % 5 == 1 ? 'bg-warning' :
                          loop.index % 5 == 2 ? 'bg-success' :
                          loop.index % 5 == 3 ? 'bg-danger' : 'bg-primary'}"
                                             role="progressbar"
                                             style="width: ${formulario.value * 10}px;
                                             aria-valuenow="${formulario.value}" aria-valuemin="0" aria-valuemax="/* Define un máximo lógico */">
                                                ${formulario.value}
                                        </div>
                                    </div>
                                </c:forEach>
