                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tablaAsig" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-success" href="<%=request.getContextPath()%>/ServletA?action=regCrear&id_asig=<%= item.get("id_asignacion") %>&id_formulario=<%= item.get("id_formulario") %>">Crear Registro</a></td>
                                    </tr>
                                    <%
                                            }
