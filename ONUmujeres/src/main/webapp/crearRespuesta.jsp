...
<%@ page import="com.example.onumujeres.beans.Pregunta" %>
<%@ page import="com.example.onumujeres.beans.Seccion" %>
<%@ page import="com.example.onumujeres.beans.OpcionPregunta" %>
<%
