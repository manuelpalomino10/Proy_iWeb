...
(27, 3, 5, 33333335, '2024-12-06'),
(28, 3, 6, 33333336, '2025-02-21'),
(29, 3, 7, 33333337, '2024-12-07'),
(30, 3, 8, 33333338, '2025-02-02'),

(31, 4, 1, 44444441, '2025-01-02'),
(32, 4, 3, 44444443, '2025-01-06'),
(33, 4, 4, 44444444, '2024-11-16'),
(34, 4, 5, 44444445, '2024-12-06'),
(35, 4, 6, 44444446, '2025-02-21'),
(36, 4, 7, 44444447, '2024-12-07'),
(37, 4, 8, 44444448, '2025-02-02'),

(38, 5, 1, 55555551, '2025-01-02'),
(39, 5, 3, 55555553, '2025-01-06'),
(40, 5, 4, 55555554, '2024-11-16'),
(41, 5, 5, 55555555, '2024-12-06'),
(42, 5, 6, 55555556, '2025-02-21'),
(43, 5, 7, 55555557, '2024-12-07'),
(44, 5, 8, 55555558, '2025-02-02'),

(45, 6, 1, 66666661, '2025-01-02'),
(46, 6, 3, 66666663, '2025-01-06'),
(47, 6, 4, 66666664, '2024-11-16'),
(48, 6, 5, 66666665, '2024-12-06'),
(49, 6, 6, 66666666, '2025-02-21'),
(50, 6, 7, 66666667, '2024-12-07'),
(51, 6, 8, 66666668, '2025-02-02');
...
(5,'2025-04-01','B',3), (6,'2025-04-04','B',3),
(7,'2025-01-03','C',4), (8,'2025-01-05','C',4),
(9,'2025-02-01','B',5), (10,'2025-02-02','B',5),
(11,'2025-03-13','B',6), (12,'2025-03-14','B',6),
(13,'2024-12-21','B',7), (14,'2024-12-22','B',7),
-- encuestador 8
(15,'2025-02-16','C',8), (16,'2025-02-16','C',8), (17,'2025-02-17','C',8),
(18,'2025-03-17','B',10), (19,'2025-03-20','B',10),
(20,'2025-03-17','B',11), (21,'2025-03-20','B',11),
(22,'2025-03-17','B',12), (23,'2025-03-20','B',12),
-- encuestador 9
(24,'2025-03-01','C',13), (25,'2025-03-02','C',13),
(26,'2025-03-03','B',14), (27,'2025-03-05','B',14),
(28,'2024-12-26','B',15),
-- encuestador 10
(29,'2025-03-10','C',17),
-- encuestador 11
(30,'2025-02-12','C',20),(31,'2025-02-28','C',20);
...
(2, 'Nombres y apellidos de la persona que encuesta', 'text', 1,1),
	(3, 'Nombre del asentamiento humano',       'text',     2,1),
	(4, 'Sector',                               'text',     2,1),
		(5, 'Nombres y apellidos',                  'text',     3,1),
		(6, 'Edad',                                 'un medium int',      3,1),
		(7, 'Dirección',                            'text',     3,1),
		(8, 'Celular (opcional)',                   'tel',     3,0),
			(9, '¿Hay niños/niñas de 0 a 5 años en el hogar?',       'combobox', 4,1),
			(10, '¿Cuántos niños/niñas de 0 a 5 años hay en el hogar?', 'un small int',    4,0),
			...
			(12, '¿Por qué no usa guarderías o centros de cuidado?',  'combobox', 4,0),
				...
				(14, '¿Cuántas personas adultas mayores hay en el hogar? ', 'un small int', 5,0),
                ...
                (16, '¿Usan apoyos para movilizarse como sillas de rueda, bastón, muletas?', 'combobox', 5,0),
					...
					(18, '¿Cuántas personas con discapacidad o con enfermedad crónica hay en el hogar?', 'un small int', 6,0),
					...
					(20, '¿Tienen carnet CONADIS?','combobox' , 6,0),
						...
						(22, '¿Qué edad tiene?', 'un medium int' , 7,0),
                        ...
                        (24, '¿Participa en algún sindicato u organización?', 'combobox' , 7,0),
							(25, '¿Cuánto tiempo al día le dedica al cuidado (lavar, planchar, cocinar, criar, cuidar enfermos/as, etc.)?', 'text' , 8,1),
                            ...
                            (28, '¿Usted tiene algún emprendimiento (negocio)?', 'combobox' , 8,0),
								(29, 'Registrar todas las incidencias en la aplicación de la ficha o información complementaria. Enumere las preguntas si recurre a esta opción.', 'text' , 9,0),

-- form 3 con 20 preguntas
(36, 'Nombre completo', 'text', 10, 1),
(37, 'Edad', 'un medium int', 10, 1),
(38, 'Número de miembros en el hogar', 'un small int', 10, 1),
...
(40, 'Nivel educativo alcanzado', 'combobox', 10, 1),
	...
	(44, 'Fecha de ingreso a la institución', 'date', 11, 0),
	(45, 'Localidad de la institución', 'text', 11, 0),
		(46, '¿Ha recibido capacitación profesional?', 'combobox', 12, 1),
		(47, 'Área de la capacitación recibida', 'text', 12, 0),
		(48, 'Duración del curso (horas)', 'un medium int', 12, 0),
		(49, 'Fecha en que realizó la capacitación', 'date', 12, 0),
		(50, 'Nivel de utilidad de la capacitación', 'text', 12, 0),
			(51, '¿Ha enfrentado barreras educativas?', 'combobox', 13, 1),
			(52, 'Tipo de barreras enfrentadas', 'text', 13, 0),
...
(80, 'Dirección de residencia', 'text', 18, 1),
	(81, '¿Ha recibido capacitación en tecnología?', 'combobox', 19, 1),
	(82, 'Tipo de capacitación recibida', 'Default', 19, 0),
	(83, 'Duración del curso (horas)', 'un medium int', 19, 0),
	(84, 'Fecha de finalización del curso', 'date', 19, 0),
	(85, 'Nivel de satisfacción con la capacitación', 'text', 19, 0),
		(86, '¿Tiene acceso a internet en el hogar?', 'combobox', 20, 1),
		(87, 'Tipo de conexión (fibra, ADSL, etc.)', 'Default', 20, 0),
		(88, 'Velocidad de conexión (Mbps)', 'un medium int', 20, 0),
		(89, 'Fecha de instalación del servicio', 'date', 20, 0),
		(90, 'Comentarios sobre la conectividad', 'text', 20, 0),
			(91, '¿Interesada en adquirir nuevos dispositivos?', 'combobox', 21, 1),
			(92, 'Tipo de dispositivo requerido', 'Default', 21, 0),
			(93, 'Cantidad de dispositivos necesarios', 'un small int', 21, 0),
			(94, 'Fecha prevista para la adquisición', 'date', 21, 0),
			(95, 'Comentarios sobre requerimientos tecnológicos', 'text', 21, 0),

-- form 6 con 20 preguntas
(96, 'Nombre completo', 'text', 22, 1),
(97, 'Número de identificación', 'text', 22, 1),
(98, 'Nacionalidad', 'combobox', 22, 1),
(99, 'Fecha de nacimiento', 'date', 22, 1),
(100, 'Correo electrónico', 'email', 22, 1),
	(101, '¿Dispone de dispositivos tecnológicos adecuados?', 'combobox', 23, 1),
	(102, 'Cantidad de dispositivos en uso', 'un small int', 23, 0),
	(103, 'Fecha de la última actualización de dispositivos', 'date', 23, 0),
	(104, 'Opinión sobre la brecha tecnológica', 'text', 23, 0),
	(105, 'Principales barreras al acceso a tecnología', 'text', 23, 0),
		(106, 'Nivel de satisfacción con los servicios digitales', 'un small int', 24, 0),
		(107, 'Recomendaciones para mejoras', 'text', 24, 0),
		(108, '¿Considera útil la implementación tecnológica?', 'combobox', 24, 0),
		(109, 'Fecha de evaluación', 'date', 24, 0),
		(110, 'Comentarios adicionales', 'text', 24, 0),
			(111, 'Impacto del acceso digital en su vida', 'combobox', 25, 0),
			(112, 'Nivel de dependencia de la tecnología', 'un small int', 25, 0),
			(113, 'Fecha del último cambio tecnológico', 'date', 25, 0),
			(114, 'Percepción de cambios en la comunidad', 'text', 25, 0),
			(115, 'Sugerencias para futuros proyectos', 'text', 25, 0),

-- form 7 con 20 preguntas
(116, 'Nombre completo', 'text', 26, 1),
(117, 'Años de experiencia laboral', 'un medium int', 26, 1),
(118, 'Sector de empleo principal', 'text', 26, 1),
(119, 'Tipo de empleo actual', 'combobox', 26, 1),
(120, 'Capacitación laboral previa', 'combobox', 26, 1),
	(121, 'Horas laborales semanales', 'un medium int', 27, 0),
	(122, 'Salario mensual aproximado', 'un large int', 27, 0),
	(123, 'Descripción de las condiciones laborales', 'text', 27, 0),
	(124, 'Tipo de contrato laboral', 'combobox', 27, 0),
	(125, 'Ingreso extra o compensaciones', 'text', 27, 0),
		...
		(130, 'Satisfacción con los derechos laborales', 'text', 28, 0),
			(131, 'Expectativa salarial justa', 'un large int', 29, 0),
			...
			(135, 'Sugerencias para mejorar las condiciones laborales', 'text', 29, 0),

-- form 8 con 20 preguntas
(136, 'Nombre completo', 'text', 30, 1),
(137, 'Número de identificación', 'dni', 30, 1),
(138, 'Nacionalidad', 'combobox', 30, 1),
(139, 'Fecha de nacimiento', 'date', 30, 1),
(140, 'Correo electrónico', 'email', 30, 1),
(141, 'Tipo de labor realizada', 'text', 30, 1),
	(142, 'Descripción del ambiente de trabajo', 'text', 31, 0),
	(143, '¿Existen jornadas excesivas?', 'combobox', 31, 0),
	(144, 'Fecha de inicio en el trabajo actual', 'date', 31, 1),
	(145, 'Comentarios sobre las condiciones de trabajo', 'text', 31, 0),
		(146, 'Salario percibido', 'un large int', 32, 0),
		(147, 'Frecuencia de pago', 'combobox', 32, 0),
		(148, 'Beneficios laborales adicionales', 'text', 32, 0),
		(149, 'Fecha de la última revisión salarial', 'date', 32, 0),
		(150, 'Satisfacción con la remuneración', 'text', 32, 0),
			(151, 'Nivel de satisfacción laboral (0-20)', 'un small int', 33, 0),
			...
			(155, 'Propuestas para mejorar el entorno laboral', 'text', 33, 0);
...
-- se hace con el archivo respuestas_insert.sql en baseDatos_final
