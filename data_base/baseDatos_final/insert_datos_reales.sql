		...
		(8, 'Celular (opcional)',                   'int',     3,0),
			...
			(12, '¿Por qué no usa guarderías o centros de cuidado?',  'combobox', 4,0),
                ...
                (16, '¿Usan apoyos para movilizarse como sillas de rueda, bastón, muletas?', 'combobox', 5,0),
					...
					(16, '¿Tienen carnet CONADIS?','combobox' , 6,0),
						(17, '¿Alguna persona integrante de su hogar se dedica al trabajo doméstico remunerado?','combobox' , 7,1),
						(18, '¿Qué edad tiene?', default , 7,0),
                        (19, '¿Actualmente está contratada (tiene contrato formal) en la casa donde trabaja?', 'combobox' , 7,0),
                        (20, '¿Participa en algún sindicato u organización?', 'combobox' , 7,0),
							(21, '¿Cuánto tiempo al día le dedica al cuidado (lavar, planchar, cocinar, criar, cuidar enfermos/as, etc.)?', default , 8,1),
                            (22, '¿Conoce los servicios de cuidados:cuna más, OMAPED,CIAM, etc.?', 'combobox' , 8,0),
                            (23, '¿Usted realiza algún trabajo remunerado fuera de casa?', 'combobox' , 8,0),
                            (24, '¿Usted tiene algún emprendimiento (negocio)?', 'combobox' , 8,0),
								(26, 'Registrar todas las incidencias en la aplicación de la ficha o información complementaria. Enumere las preguntas si recurre a esta opción.', default , 9,0),
